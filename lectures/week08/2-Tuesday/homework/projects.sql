...
-- !Based on the previous query, get the count of the number of techs used by each project. working
...
-- !Based on the previous query, get the count of the number of projects that use each tech. working
